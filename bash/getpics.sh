...
####################################################
# Make sure you have a picture directory
####################################################
...
test -f ~/Picture/pics.tgz || wget -q -O ~/Pictures/pics.tgz http://zonzorp.net/pics.tgz
echo **
test -f ~/Picture/pics.tgz && tar -xzf ~/Pictures/pics.tgz && rm ~/Pictures/pics.tgz
